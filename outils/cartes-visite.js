...
const CARTES = [
  ...
  },
  {
    ...
    // Le retour est écrit : laissée à l'équilibrage automatique, la phrase coupait après
    // « une », qui ne veut rien dire tout seul en fin de ligne.
    services: 'Une notification, une mission,<br>une facture et un paiement automatique',
    metiers: null,
...
function feuille(c, polices) {
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .v-pied{margin-top:2.2mm;font-size:2mm;font-weight:700;letter-spacing:.06em;
    text-transform:uppercase;color:#fff;opacity:.78;max-width:50mm;text-wrap:balance}
